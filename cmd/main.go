...
import (
	...
	"github.com/enterprisewebservice/agent-office-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(agentofficev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.MemoryModuleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MemoryModule")
		os.Exit(1)
	}
	if err := (&controller.AgentWorkstationReconciler{
		Client:     mgr.GetClient(),
		Scheme:     mgr.GetScheme(),
